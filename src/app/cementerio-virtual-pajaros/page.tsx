...
const pageSlug = 'cementerio-virtual-pajaros';
const canonical = getCanonicalUrl(`/${pageSlug}`);
const ogImage = getOgImageUrl(pageSlug, 'landing');

const breadcrumbs = [{ name: 'Home', url: 'https://memorias-eternas.app' }, { name: 'Pájaros', url: canonical }];
const faqs = [{ question: '¿Memorial para pájaros?', answer: 'Sí, recuerda a tu pájaro para siempre.' }, { question: '¿Gratis?', answer: 'Sí.' }, { question: '¿Compartir?', answer: 'Sí.' }];

export default function CementerioVirtualPajaros() {
  const localBusinessSchema = generateLocalBusinessSchema('Cementerio Virtual para Pájaros');
  const breadcrumbSchema = generateBreadcrumbSchema(breadcrumbs);
  const faqSchema = generateFAQSchema(faqs);
  const webPageSchema = generateWebPageSchema('Cementerio Virtual para Pájaros - Forever Pet Friend', 'Memorial para pájaros.', canonical, ogImage);
  return (
