...
const pageSlug = 'cementerio-virtual-cobayas';
const canonical = getCanonicalUrl(`/${pageSlug}`);
const ogImage = getOgImageUrl(pageSlug, 'landing');

const breadcrumbs = [{ name: 'Home', url: 'https://memorias-eternas.app' }, { name: 'Cobayas', url: canonical }];
const faqs = [{ question: '¿Puedo crear un memorial para mi cobaya?', answer: 'Sí, honra a tu cobaya con fotos, historias y recuerdos.' }, { question: '¿Es gratis?', answer: 'Sí, completamente gratuito.' }, { question: '¿Puedo compartir?', answer: 'Sí, comparte con tu comunidad.' }];

export default function CementerioVirtualCobayas() {
  const localBusinessSchema = generateLocalBusinessSchema('Cementerio Virtual para Cobayas');
  const breadcrumbSchema = generateBreadcrumbSchema(breadcrumbs);
  const faqSchema = generateFAQSchema(faqs);
  const webPageSchema = generateWebPageSchema('Cementerio Virtual para Cobayas - Forever Pet Friend', 'Memorial eterno para cobayas.', canonical, ogImage);
  return (
