...
const pageSlug = 'registrar-perro-cementerio-virtual';
const canonical = getCanonicalUrl(`/${pageSlug}`);
const ogImage = getOgImageUrl(pageSlug, 'landing');

const breadcrumbs = [{ name: 'Home', url: 'https://memorias-eternas.app' }, { name: 'Registrar Perro Cementerio Virtual', url: canonical }];
...
export default function Page() {
  const localBusinessSchema = generateLocalBusinessSchema('Registrar Perro Cementerio Virtual');
  const breadcrumbSchema = generateBreadcrumbSchema(breadcrumbs);
  const faqSchema = generateFAQSchema(faqs);
  const webPageSchema = generateWebPageSchema('Registrar Perro Cementerio Virtual - Forever Pet Friend', 'Memorial para mascotas.', canonical, ogImage);
