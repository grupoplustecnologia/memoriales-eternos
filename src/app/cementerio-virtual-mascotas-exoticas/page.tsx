...
const pageSlug = 'cementerio-virtual-mascotas-exoticas';
const canonical = getCanonicalUrl(`/${pageSlug}`);
const ogImage = getOgImageUrl(pageSlug, 'landing');

const breadcrumbs = [{ name: 'Home', url: 'https://memorias-eternas.app' }, { name: 'Mascotas Exóticas', url: canonical }];
const faqs = [{ question: '¿Memorial para mascotas exóticas?', answer: 'Sí, todas las mascotas merecen un memorial.' }, { question: '¿Gratis?', answer: 'Sí.' }, { question: '¿Compartir?', answer: 'Sí.' }];

export default function CementerioVirtualMascotasExoticas() {
  const localBusinessSchema = generateLocalBusinessSchema('Cementerio Virtual para Mascotas Exóticas');
  const breadcrumbSchema = generateBreadcrumbSchema(breadcrumbs);
  const faqSchema = generateFAQSchema(faqs);
  const webPageSchema = generateWebPageSchema('Cementerio Virtual para Mascotas Exóticas - Forever Pet Friend', 'Memorial para mascotas exóticas.', canonical, ogImage);
  return (
