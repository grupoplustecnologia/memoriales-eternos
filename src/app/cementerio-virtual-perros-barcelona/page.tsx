      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow"><div className="text-4xl mb-4">🎪</div><h3 className="text-xl font-semibold mb-3 text-gray-900">Razas</h3><p className="text-gray-600">Todos los perros son bienvenidos.</p></Card>
            <Card className="p-6 hover:shadow-lg transition-shadow"><div className="text-4xl mb-4">📍</div><h3 className="text-xl font-semibold mb-3 text-gray-900">Barcelona</h3><p className="text-gray-600">Comunidad barcelonesa de perros.</p></Card>
            <Card className="p-6 hover:shadow-lg transition-shadow"><div className="text-4xl mb-4">💝</div><h3 className="text-xl font-semibold mb-3 text-gray-900">Recuerdos</h3><p className="text-gray-600">Fotos y historias de tu perro.</p></Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow"><div className="text-4xl mb-4">🌟</div><h3 className="text-xl font-semibold mb-3 text-gray-900">Eterno</h3><p className="text-gray-600">Tu perro vivirá en la memoria eterna.</p></Card>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <Card className="p-6"><h3 className="text-xl font-semibold mb-3 text-gray-900">¿Todas las razas?</h3><p className="text-gray-600">Sí, cualquier perro puede tener memorial.</p></Card>
